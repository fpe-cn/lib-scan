...
(function(l) {
    ...
    if (window.getComputedStyle) {
        k = function(ag) {
            var af, ae;
            af = l.isFunction(ag.getEL) ? ag.getEL() : ag;
            ae = af.ownerDocument.defaultView;
            if (!ae || !ae.opener) {
                ae = window
            }
...
(function(m, l) {
    ...
    g.pushDialog = function(t) {
        ...
        s.className = "dynamsoft-backdrop";
        if (j) {
...
Dynamsoft.Lib.ready(function() {
    ...
    Dynamsoft.Lib.install._strDynamsoftWithClose = ['<div style="height:40px;width:350px;position:relative;">', '<span><div class="dynamsoft-dwt-DYNLogo" ', 'alt="Dynamsoft Corporation" border="0"></div>', "</span>", '<div style="height:30px;padding-left:205px; position:absolute; top:0; left:120px">', '<a href="javascript: void(0)" style="text-decoration:none; padding:15px" class="dynamsoft-closetblCanNotScan">X</a>', "</div></div>"].join("");
    Dynamsoft.Lib.install._strDynamsoftWithoutClose = ['<div style="height:40px;width:350px;position:relative;">', '<span><div class="dynamsoft-dwt-DYNLogo" ', 'alt="Dynamsoft Corporation" border="0"></div>', "</span>", "</div>"].join("");
...
Dynamsoft.WebTwainEnv.ShowDialog = function(f, j, k, a, g) {
    var b = Dynamsoft.Lib,
        e = b.install,
        n;
    if (!b.get("dynamsoft_waiting")) {
        var c = document.createElement("div");
        c.className = "dynamsoft-dialog-wrap";
        c.style.width = "100%";
        if (a) {
            n = ['<div id="dynamsoft_waiting" class="dynamsoft-dialog" style="width:455px;">', '<div class="dynamsoft-dialog-header"></div>', '<div class="dynamsoft-dialog-body">', '<div class="dynamsoft-dialog-content"><div id="', e._divInstallBody, '"></div></div></div>', '<div class="dynamsoft-dialog-footer"></div>', "</div>"]
        } else {
            n = ['<div id="dynamsoft_waiting" class="dynamsoft-dialog">', '<div class="dynamsoft-dialog-header"></div>', '<div class="dynamsoft-dialog-body">', '<div class="dynamsoft-dialog-content"><div id="', e._divInstallBody, '"></div></div></div>', '<div class="dynamsoft-dialog-footer"></div>', "</div>"]
        }
        c.innerHTML = n.join("");
        if (a) {
    ...
    if (a) {
        b.get(e._divInstallBody).innerHTML = ['<div class="dynamsoft-dwt-dialog-body" style="height:' + j + "px;width:" + f + 'px">', k, "</div>"].join("")
    } else {
        var l = (g ? e._strDynamsoftWithoutClose : e._strDynamsoftWithClose);
        b.get(e._divInstallBody).innerHTML = ['<div class="dynamsoft-dwt-dialog-body" style="height:' + j + 'px">', l, k, "</div>"].join("")
    }
    var m = b.get("dynamsoft_waiting");
    m.style.width = f;
    ...
    for (var h = 0; h < document.links.length; h++) {
        if (document.links[h].className == "dynamsoft-closetblCanNotScan") {
...
function DCP_DWT_OnClickCloseInstall(a) {
    ...
    a.detect.OnWebTwainPreExecute = function() {
        ...
        b.className = "dynamsoft-dialog-wrap";
        b.innerHTML = c;
...
(function() {
    Dynamsoft.Lib.Errors = {
        ...
        ConvertBinaryIndexMoreThanOne: function(a) {
            a._errorCode = -2372;
            a._errorString = "You cannot convert to binary more than one image when the format is BMP, JPG or PNG."
        },
        __last: false
    }
})();
...
(function(a) {
    ...
    j = a.html5.Funs = {
        ...
        init: function(p, A) {
            var l, m, w, k, t, s, v, z, n;
            z = [];
            z.push('<dialog class="dynamsoft-dwt-dialogProgress" style="top:30%"><h3 class="dynamsoft-finalMessage"></h3><p class="dynamsoft-status">0%</p>');
            if (a.env.bIE) {
                z.push('<div class="dynamsoft-progressBar" value="" max="100"></div>')
            } else {
                z.push('<progress class="dynamsoft-progressBar" value="" max="100"></progress>')
            }
            z.push('<br /><button class="dynamsoft-btnCancel" value="cancel" autofcus >cancel</button></dialog>');
            n = '<div class="dynamsoft-dwt-container-box"></div>';
            m = a.one("#" + A);
            m.html("");
            m.attr("class", p.containerClass);
            m.append(n);
            s = m.one(".dynamsoft-dwt-container-box");
            if (s) {
                s.style("position", "relative");
                j.changeImageUISize(p, p._width, p._height)
            }
            if (!a.dlgProgress) {
                t = a.one(".dynamsoft-dwt-dialogProgress");
                if (t) {
                    t.remove()
                }
                var r = a.parseHTML(z.join(""));
                if (r && r.length > 0) {
                    document.body.appendChild(r[0])
                }
                if (a.env.bIE) {
                    var x = a.one(".dynamsoft-progressBar"),
                        y = x && x[0];
                    if (y) {
                        y.objProgressBar = new a.ProgressBar(y, {
                            width: 300,
                            height: 20
                        })
                    }
                ...
                if (t) {
                    a.dlgProgress = t[0];
                    a.dialog.setup(a.dlgProgress)
                }
                a.dlgRef = 0;
                a.dialogShowStatus = f;
                a.cancelFrome = 0;
                var u = function() {
                    var B = a.cancelFrome;
                    a.closeProgress(0);
                ...
                var q = a.one(".dynamsoft-btnCancel");
                if (q) {
                    a.addEventListener(q[0], "mousedown", u)
                }
            }
            j.initImageUI(p, s)
        },
        initImageUI: function(p, r) {
            var l, k, m = p._width,
                q = p._height,
                n = f;
            l = a.one("#" + p._strDWTControlContainerID);
            if (a.isString(m) && m.indexOf("%") >= 0) {
                m = a.css(l, "width") * parseInt(m) / 100;
                n = d
            } else {
                m = parseInt(m)
            }
            if (a.isString(q) && q.indexOf("%") >= 0) {
                q = a.css(l, "height") * parseInt(q) / 100;
                n = d
            } else {
                q = parseInt(q)
            }
            ...
            j.bindUIViewEvents(p, k);
            p._UIManager = new a.UI.ImageUIManager(p, k);
            if (n) {
                j.changeImageUISize(p, p._width, p._height)
            }
        },
        changeImageUISize: function(p, n, q) {
            var l, m, u = -1,
                x = -1,
                k = n,
                w = q,
                ...
                v, r;
            l = a.one("#" + p._strDWTControlContainerID);
            if (a.isString(n) && n.indexOf("%") >= 0) {
                v = a.css(l, "width") * parseInt(n) / 100;
                t = d
            } else {
                v = parseInt(n);
                k = [v + 2, "px"].join("")
            ...
            if (a.isString(q) && q.indexOf("%") >= 0) {
                r = a.css(l, "height") * parseInt(q) / 100;
                t = d
            } else {
                r = parseInt(q);
                w = [r + 2, "px"].join("")
            ...
            if (l) {
                m = l.one(".dynamsoft-dwt-container-box");
                if (m) {
                    m.style("width", k);
                    m.style("height", w)
                }
            ...
            if (t) {
                if (!p.__funResize) {
                    p.__funResize = function() {
                        var y = j.__innerGetUIViewRealSize(p._strDWTControlContainerID, p._width, p._height);
                        if (p._UIManager) {
                            return p._UIManager.ChangeSize(y.width, y.height)
                        }
                        return d
                    }
                }
                a.removeEventListener(window, "resize", p.__funResize);
                a.addEventListener(window, "resize", p.__funResize)
            } else {
                if (p.__funResize) {
                    a.removeEventListener(window, "resize", p.__funResize);
                    p.__funResize = f
            ...
            var s = j.__innerGetUIViewRealSize(p._strDWTControlContainerID, v, r);
            if (p._UIManager) {
                return p._UIManager.ChangeSize(s.width, s.height)
            }
            return d
        },
        __innerGetUIViewRealSize: function(m, k, p) {
            var l, n = -1,
                q = -1;
            l = a.one("#" + m);
            if (a.isString(k) && k.indexOf("%") >= 0) {
                n = a.css(l, "width") * parseInt(k) / 100
            }
            if (n < 0 && k) {
                n = parseInt(k)
            }
            if (a.isString(p) && p.indexOf("%") >= 0) {
                q = a.css(l, "height") * parseInt(p) / 100
            }
            if (q < 0 && p) {
                q = parseInt(p)
            }
        ...
        bindUIViewEvents: function(m, k) {
            var n = m,
                l;
            k.onSelected = function(p) {
                var r = p.length,
                    q;
                if (r > 0) {
                    n.__SelectedImagesCount = r;
                    q = p[r - 1];
                    n.__cIndex = q;
                    l = j.__SetSelectedImages(n, n.__cIndex, p);
                    if (l && a.isFunction(n.__OnRefreshUI)) {
                        n.__OnRefreshUI(q)
                    }
                } else {
                    n.__SelectedImagesCount = 0
                }
            };
            k.onRefreshUI = function(p) {
                j.__innerRefreshFromUIView(n, p)
            };
            k.onResetCurrentIndex = function(p) {
                if (p >= 0 && n.__cIndex != p) {
                    n._innerFun("CurrentImageIndexInBuffer", j.makeParams(p));
                    n.__cIndex = p
                }
            };
            k.onMouseMove = function(r) {
                var q = r.index;
                if (r) {
                    var p = r.x,
                        s = r.y;
                ...
                if (a.isFunction(n.__OnMouseMove)) {
                    n.__OnMouseMove(q)
                }
            };
            k.onMouseClick = function(r) {
                var q = r.index;
                if (r) {
                    var p = r.x,
                        s = r.y;
                ...
                if (a.isFunction(n.__OnMouseClick)) {
                    n.__OnMouseClick(q)
                }
            };
            k.onMouseDoubleClick = function(q) {
                var p = q.index;
                if (a.isFunction(n.__OnMouseDoubleClick)) {
                    n.__OnMouseDoubleClick(p)
                }
            };
            k.onMouseRightClick = function(r) {
                var q = r.index;
                if (r) {
                    var p = r.x,
                        s = r.y;
                ...
                if (a.isFunction(n.__OnMouseRightClick)) {
                    return n.__OnMouseRightClick(q)
                }
                return d
            };
            k.onImageAreaSelected = function(p) {
                if (a.isFunction(n.__OnImageAreaSelected)) {
                    n.__OnImageAreaSelected(p.index, p.left, p.top, p.right, p.bottom)
                }
            };
            k.onImageAreaDeSelected = function(p) {
                if (a.isFunction(n.__OnImageAreaDeSelected)) {
                    n.__OnImageAreaDeSelected(p)
                }
            }
        },
        ...
        getJson: function(s, l, t, k) {
            ...
            r.push(l);
            r.push('"');
            r.push(',"module":"dwt","version":"');
            var q = Dynamsoft.WebTwainEnv,
                n = [q.Trial ? "dwt_trial_" : "dwt_", a.replaceAll(q.ServerVersionInfo, ",", "")].join("");
            r.push(n);
            r.push('"');
        ...
        loadHttpBlob: function(r, y, q, s, z, k, x, l) {
            var p = "loadHttpBlob",
                A, u, w = f;
            A = function(G, D, F) {
                var C, E;
                if (G && a.isArray(G) && G.length > 2) {
                    C = G[1];
                    E = G[2]
                } else {
                    C = D;
                ...
                if (E.state == 2 && E.status == 0) {
                    if (E.statusText === "abort") {
                        var m = d;
                        a.Errors.HttpDownloadError(r, m)
                    } else {
                        a.Errors.HttpDownloadUrlError(r)
                    }
                } else {
                    a.Errors.HttpDownloadError(r, f, C, E.status)
                }
                if (a.isFunction(k)) {
                    k()
                }
            ...
            if (r.HTTPUserName != "") {
                u.username = r.HTTPUserName;
                u.password = r.HTTPPassword
            }
            if (s) {
                u.dataType = "blob";
                if (a.isFunction(x)) {
                    u.beforeSend = function(m) {
                ...
                if (a.env.bIE) {
                    u.dataType = "arraybuffer";
                    u.onSuccess = function(F, E, D) {
                        var G, C, m;
                        G = F || D.responseData;
                        if (G) {
                            m = new Uint8Array(G)
                        ...
                        r._errorString = "";
                        z(m);
                        r._HowManyImagesInBuffer = r._innerFun("HowManyImagesInBuffer");
                        r.__cIndex = r._innerFun("CurrentImageIndexInBuffer");
                        w = d
                    }
                } else {
                    u.contentType = "text/plain; charset=x-user-defined";
                    u.mimeType = "text/plain; charset=x-user-defined";
                    u.onSuccess = function(G, F, E) {
                        var H, C, m;
                        H = E.responseText;
                        C = H.length;
                        m = new Uint8Array(C);
            ...
            if (y == "post") {
                var t = r.httpFormFields,
                    n;
                if (t) {
                    try {
                        n = new FormData();
                        a.each(t, function(C, m) {
        ...
        getServerImageUrlPrefix: function(n, p) {
            var l = n.httpUrl,
                k = f,
                m = [l, "dwt/dwt_", h.Trial ? "trial_" : "", a.replaceAll(h.ServerVersionInfo, ",", ""), "/img?id=", n.clientId];
            return m.join("")
        },
        getServerSmallImageUrl: function(p, q, m) {
            var l = p.httpUrl,
                k = f,
                n = [l, "dwt/dwt_", h.Trial ? "trial_" : "", a.replaceAll(h.ServerVersionInfo, ",", ""), "/img?id=", p.clientId];
            ...
            if (m) {
                ...
                n.push("&width=");
                n.push(k ? "-1" : p._width / 2);
                n.push("&height=");
                n.push(k ? "-1" : p._height / 2)
            }
            return n.join("")
        },
        combineUrl: function(p, l, n) {
            var k = [],
                m = l;
            ...
            if (m.indexOf(":") < 0) {
                if (p.HTTPPort == "") {
                    p.HTTPPort = a.detect.ssl ? 443 : 80
                }
                if ((!a.detect.ssl && p.HTTPPort != 80) || (a.detect.ssl && p.HTTPPort != 443)) {
                    k.push(":");
                    k.push(p.HTTPPort)
                }
            }
        ...
        httpPostUpload: function(q, k, p, t, w, l, r, s, y) {
            if (!p || p.size <= 0) {
            ...
            var n = q.MaxUploadImageSize,
                v = p.size,
                u = p.type,
                m;
            if (v > n && n != -1) {
                a.Errors.UploadExceededMaxSize(q);
                if (a.isFunction(y)) {
                    y()
                }
                return f
            }
            if (u === "" || u && u != q.HttpContentTypeFieldValue) {
                var x = p.slice || p.webkitSlice || p.mozSlice;
                m = x.call(p, 0, v, q.HttpContentTypeFieldValue);
                m.name = p.name
            } else {
                m = p
            }
            m.remoteFilename = q.__remoteFilename;
            return this.httpUploadByBIO(q, k, m, w, t, l, r, s, y)
        },
        httpPostUploadString: function(p, k, r, n, u, l, q, s, w) {
            var v, m, t;
            if (r == "") {
            ...
            m = p.MaxUploadImageSize;
            t = r.length;
            if (t > m && m != -1) {
                a.Errors.UploadExceededMaxSize(p);
                if (a.isFunction(w)) {
                    w()
                }
                return f
            ...
            v.name = n;
            return this.httpUploadByBIO(p, k, v, u, d, l, q, s, w)
        },
        httpUploadByBIO: function(q, l, k, u, t, m, r, s, w) {
            var x, p, v, n;
            v = q.httpFormFields;
            n = new FormData();
            ...
            if (x) {
                ...
                if (q.__withCredentials) {
                    a.mix(p.xhrFields, {
                        withCredentials: true
                    })
                }
            }
            q.__HTTPPostResponseString = f;
            a.bio.on(a.BIO.event.SUCCESS, function(y) {
                a.bio = f;
                if (y && a.isString(y.response)) {
                    q.__HTTPPostResponseString = y.response
                } else {
                    q.__HTTPPostResponseString = ""
                }
                if (a.isFunction(s)) {
                    s(q.__HTTPPostResponseString)
                }
            });
            a.bio.on(a.BIO.event.ERROR, function(B) {
                var z = (B && B.canceled),
                    C = (B && B.timeout),
                    y = f,
                    A = f;
                a.bio = f;
                if (B && a.isString(B.response)) {
                    q.__HTTPPostResponseString = B.response
                } else {
                    q.__HTTPPostResponseString = ""
                }
                if (!z) {
                ...
                a.Errors.UploadError(q, z, y, A);
                if (a.isFunction(w)) {
                    w(q.__HTTPPostResponseString)
                }
            });
            if (r) {
                a.bio.on(a.BIO.event.PROGRESS, function(y) {
                    delete(y.totalSize);
                    delete(y.position);
                    var z = (y.total === 0) ? 100 : Math.round(y.loaded * 100 / y.total),
                        A = [y.loaded, " / ", y.total].join("");
                    q._OnPercentDone([0, z, "", "http"])
                });
                q._OnPercentDone([0, -1, "uploading...", "http"])
            }
            return a.bio.upload(k)
        },
        httpPutImage: function(n, k, m, p, t, l, r) {
            var s = d,
                q = {
                    method: "PUT",
                    url: k,
                    ...
                    beforeSend: function(u) {
                        if (a.isFunction(r)) {
                            u.upload.addEventListener("progress", function(v) {
                                delete(v.totalSize);
                                delete(v.position);
                                r(v)
                            }, f)
            ...
            if (n.HTTPUserName != "") {
                q.username = n.HTTPUserName;
                q.password = n.HTTPPassword
            }
            if (!p) {
                a.mix(q, {
                    headers: {
        ...
        setBtnCancelVisibleForProgress: function(m, l) {
            var k = this;
            if ((a.cancelFrome == 0 && m.__IfShowProgressBar == d) || (a.cancelFrome != 0 && m.__IfShowCancelDialogWhenImageTransfer == d)) {
                var p = a.one(".dynamsoft-btnCancel"),
                    n = p && p[0];
                if (n) {
                    if (l == f) {
        ...
        handleEvent: function(n, l) {
            ...
            if (p) {
                a.log("handled event:" + l.event);
                a.each(j.SEND_BACK_EVENTS, function(s, r) {
                    if (j.isServerInvalid(n)) {
                        return f
                    }
                    if (l.event === s) {
                        a.log("sendback event:" + l.event);
                        j.sendData(k, j.getJson(n, l.event, j.makeParams(m), 0), f, d);
                        return f
                    }
                })
            } else {
                a.each(a.Addon_Events, function(t, s) {
                    if (l.event === t) {
                        var r = ["_", t].join("");
                        p = d;
                        if (a.isFunction(n[r])) {
                ...
                if (p) {
                    a.log("handled addon event:" + l.event);
                    a.each(a.Addon_Sendback_Events, function(s, r) {
                        if (j.isServerInvalid(n)) {
                            return f
                        }
                        if (l.event === s) {
                            a.log("sendback addon event:" + l.event);
                            j.sendData(k, j.getJson(n, l.event, j.makeParams(m), 0), f, d);
                            return f
                        }
                    })
        ...
        autoDiscardBlankImage: function(n, k) {
            if (a.config.bDiscardBlankImage) {
                ...
                if (a.isFunction(n.__OnPrintMsg)) {
                    n.__OnPrintMsg(m)
                }
            }
        },
        ...
        __innerRefreshFromUIView: function(l, m, k) {
            var n = l;
            if (m >= 0) {
                if (!k) {
                    n.CurrentImageIndexInBuffer = m
                }
                n._UIManager.refreshEditor(n._UIManager.GetCurrentImageIndex(), n._UIManager.count())
            }
            if (a.isFunction(n.__OnRefreshUI)) {
                n.__OnRefreshUI(m)
            }
        },
        ...
        isServerInvalid: function(l) {
            ...
            if (k) {
                a.Errors.Server_Invalid(n)
            } else {
                if (m) {
                    a.Errors.MustUpgradeService(n)
                }
            }
        ...
        isExpiredOrFuture: function(l, p) {
            if (l == "") {
                return f
            }
            if (!p) {
                var k = l.length;
                if (k > 2 && l[k - 2] == "/" && l[k - 1] == "0") {
                    return f
                }
            }
            var n = this.parseDateFromString(l),
                m = (new Date()).getTime(),
                q = m + (60 * 24 * 3600000);
            if (n.getTime() < m) {
                return d
        ...
        isOSOK: function(k) {
            ...
            k = k.toLowerCase();
            if (k.indexOf("windows") > -1 && (a.env.bWin || a.env.bWin64)) {
                return d
            } else {
                if (k.indexOf("mac") > -1 && a.env.bMac) {
                    return d
                } else {
                    if (k.indexOf("linux") > -1 && a.env.bLinux) {
                        return d
                    }
                }
            }
        ...
        isBrowserOK: function(k) {
            if (k == "" || k == "0") {
                return d
            }
            if (k) {
                k = k.toLowerCase();
                if (k == "chrome" && a.env.bChrome) {
                    return d
                } else {
                    if (k == "ie" && a.env.bIE) {
                        return d
                    } else {
                        if (k == "firefox" && a.env.bFirefox) {
                            return d
                        }
                    }
                }
        ...
        isBindDomainOK: function(r) {
            if (a.isUndefined(r) || r == null || r == "" || r == "*" || r == "*.*") {
                return d
            }
            ...
            var v = u.toLowerCase().split("."),
                l = v.length,
                p = r.toLowerCase().split(";");
        ...
        parseDateFromString: function(l) {
            var m, k = l;
            k = k.replace(/-/g, "/");
            m = Date.parse(k);
            if (isNaN(m)) {
        ...
        getEnumLicenseType: function(p) {
            var l = f,
                ...
                k = f;
            if (a.isString(p)) {
                a.each(p.split(";"), function(w) {
                    var v = w * 1;
                    if (v == c.HTML5 || v == c.WinMacLinux) {
                        l = d
                    } else {
                        if (v == c.Barcode1D) {
                            t = d
        ...
        getLicenseType: function(p) {
            ...
            if (p && p != "") {
                p = p.toLowerCase();
                if (p == "html5" || p == "win=(aph) or mac=(ph) or linux(h)") {
                    l = d
                } else {
                    if (p == "1d barcode reader") {
                        t = d
                    } else {
                        if (p == "2d barcode reader(qrcode)") {
                            r = d
                        } else {
                            if (p == "2d barcode reader(pdf417)") {
                                n = d
                            } else {
                                if (p == "2d barcode reader(data matrix)") {
                                    u = d
                                } else {
                                    if (p == "ocr") {
                                        s = d
        ...
        isAllowLicenseType: function(k, l) {
            if (l.Core) {
                return k.Core
            } else {
                if (l.PDFRasterizer) {
                    return k.PDFRasterizer
                } else {
                    if (l.Webcam) {
                        return k.Webcam
                    } else {
        ...
        setNoAllowedLicenseTypeError: function(l, k) {
            if (k.Core) {
                a.Errors.LicenseNoCore(l)
            } else {
                if (k.PDFRasterizer) {
                    a.Errors.LicenseNoPDF(l)
                } else {
                    if (k.Webcam) {
                        a.Errors.LicenseNoWebcam(l)
                    } else {
                        if (k.barcode1D) {
                            a.Errors.LicenseNo1D(l)
                        } else {
                            if (k.QR) {
                                a.Errors.LicenseNo2DQR(l)
                            } else {
                                if (k.PDF417) {
                                    a.Errors.LicenseNo2DPDF417(l)
                                } else {
                                    if (k.DataMatrix) {
                                        a.Errors.LicenseNo2DDataMatrix(l)
                                    } else {
                                        if (k.OCR) {
                                            a.Errors.LicenseNoOCR(l)
                                        } else {
                                            if (k.OCRPro) {
                                                a.Errors.LicenseNoOCRPro(l)
                                            } else {
                                                a.Errors.LicenseEmptyOrInvalid(l)
                                            }
                                        }
                                    }
                                }
        ...
        promptLicenseErr: function(m) {
            if (m.ErrorCode < 0) {
                var l = 220,
                    k = ['<div class="dynamsoft-dwt-box-title"></div>', '<div style="margin:35px 0 0 20px;font-size:16px">', m.ErrorString, "</div>"];
                Dynamsoft.WebTwainEnv.ShowDialog(392, 220, k.join(""))
            }
        },
        checkPDFProductKeyWhenNeeds: function(p, q) {
            if (p.__addon && p.__addon.PDF) {
                var m = 1,
                    l = 2,
                    k = 4,
                    n = p.__addon.PDF.GetConvertMode();
                if (q == k) {
                    if (n == m || n == l) {
                        return this.checkProductKey(p, {
                            PDFRasterizer: d
                        })
                    }
                }
        ...
        checkProductKey: function(H, A, F) {
            var p;
            p = H.__licenseInfo;
            if (Dynamsoft.WebTwainEnv.ProductKey == "" || Dynamsoft.WebTwainEnv.ProductKey == "******" || !p || !a.isArray(p.Detail) || (p.Detail.length == 0)) {
                a.Errors.LicenseEmptyOrInvalid(H);
            ...
            var G = 0,
                ...
                w = f,
                D, x = H.__bTrial;
            if (!this.isBindDomainOK(p.Domain)) {
                a.Errors.LicenseBadDomain(H);
                this.promptLicenseErr(H);
                return f
            }
            for (D = 0; D < p.Detail.length; D++) {
                var y = p.Detail[D],
                    s = d,
                    n;
                n = this.getEnumLicenseType(y.EnumLicenseType);
                if (this.isAllowLicenseType(n, A)) {
                    if (x && y.Trial == "TRUE" || !x && y.Trial == "FALSE") {
                        var z = y.ExpireDate.replace(/-/g, "/");
                        if (!this.isExpiredOrFuture(z, x)) {
                            if (n.Core && parseInt(y.Version) >= 13 || !n.Core) {
                                if (this.isBrowserOK(y.Browser) || F) {
                                    if (this.isOSOK(y.OS)) {
                                        G++;
                                        s = f
                                    } else {
            ...
            if (k == 0) {
                this.setNoAllowedLicenseTypeError(H, A);
                this.promptLicenseErr(H);
                return f
            }
            if (m) {
                a.Errors.LicenseTrialButServiceFull(H);
                this.promptLicenseErr(H);
                return f
            }
            if (r) {
                a.Errors.LicenseFullButServiceTrial(H);
                this.promptLicenseErr(H);
                return f
            }
            if (E.length > 0) {
                var t = 0,
                    ...
                    l = (new Date()).getTime();
                for (D = 0; D < E.length; D++) {
                    var v = this.parseDateFromString(E[D]);
                    if (v.getTime() < l && v.getTime() > t) {
                        t = v.getTime();
                        z = E[D]
                    } else {
                        if (v.getTime() > l && v.getTime() < q) {
                            q = v.getTime();
                            B = E[D]
                        }
                    }
                ...
                if (z != "") {
                    var v = this.parseDateFromString(z);
                    z = this.getLicenseDateString(v);
                    a.Errors.LicenseExpired(H, z)
                } else {
                    if (B != "") {
                        var v = this.parseDateFromString(B);
                        B = this.getLicenseDateString(v);
                        a.Errors.LicenseIsFuture(H, B)
                    } else {
                        a.Errors.LicenseExpired(H, "")
                    }
                }
                this.promptLicenseErr(H);
                return f
            ...
            if (w) {
                a.Errors.LicenseLower(H);
                this.promptLicenseErr(H);
                return f
            }
            if (I) {
                if (a.env.bEdge) {
                    a.Errors.LicenseNoEdge(H)
                } else {
                    if (a.env.bChrome) {
                        a.Errors.LicenseNoChrome(H)
                    } else {
                        if (a.env.bFirefox) {
                            a.Errors.LicenseNoFirefox(H)
                        } else {
                            if (a.env.bIE) {
                                a.Errors.LicenseNoIE(H)
                            } else {
                                a.Errors.LicenseNotSupportBorwser(H)
                            }
                        }
                    }
                }
            ...
            if (u) {
                if (a.env.bWin || a.env.bWin64) {
                    a.Errors.LicenseNotSupportWindows(H)
                } else {
                    if (a.env.bMac) {
                        a.Errors.LicenseNotSupportMAC(H)
                    } else {
                        if (a.env.bLinux) {
                            a.Errors.LicenseNotSupportLinux(H)
                        } else {
                            a.Errors.LicenseNotSupportOS(H)
                        }
                    }
                }
                this.promptLicenseErr(H);
        ...
        getLicenseDateString: function(k) {
            var m = k.getFullYear(),
                l, p, n;
            l = k.getMonth() + 1;
            if (l >= 10) {
...
(function(a) {
    ...
    a.html5.STwain = function(d) {
        ...
        e._strDWTControlContainerID = f.containerID || ("dynamsoft-dwt-container-" + e.clientId);
        e._width = f.width;
        e._height = f.height;
        e._customIP = false;
        e._ssl = a.detect.ssl;
        ...
        e.containerClass = "dynamsoft-dwt-container dynamsoft-dwt-noPadding";
        ...
        e.__strProductName = "";
        e.__versionInfo = Dynamsoft.WebTwainEnv.JSVersion;
        e.__bMustUpgradeService = false;
        e.__withCredentials = false;
...
(function(c) {
    ...
    Dynamsoft.Lib.attachProperty = function(g) {
        ...
        b(h, "HTTPRequestswithCredentials", {
            get: function() {
                return h.__withCredentials
            },
            set: function(j) {
                return h.__withCredentials = j
            }
        });
...
(function(a) {
    ...
    b.__GetSelectedImagesLength = function(g, k, j, m, e) {
        var h = this,
            l = false,
            n;
        var f = false,
            p = false;
        n = h._innerFunRaw("SaveSelectedImagesToBytes", d.makeParams(g, k, "", 0, 0), j, f, p, function(q) {
            if (h.ErrorCode == 0) {
                if (a.isFunction(m)) {
                    if (a.isArray(q)) {
                        l = m(q[0])
...
(function(b) {
    ...
    var e = b.html5.STwain,
        ...
        a = !0,
        g = b.html5.Funs;
    d.FileExists = function(h) {
        var j = g.replaceLocalFilename(h);
        return this._innerFun("FileExists", g.makeParams(j))
    };
    d.SaveAllAsMultiPageTIFF = function(h, l, j) {
        var k = g.replaceLocalFilename(h);
        return this.__innerSaveImage("SaveAllAsMultiPageTIFF", g.makeParams(k), l, j)
    };
    d.SaveAllAsPDF = function(h, l, j) {
        var k = g.replaceLocalFilename(h);
        return this.__innerSaveImage("SaveAllAsPDF", g.makeParams(k), l, j)
    };
    d.SaveAsBMP = function(h, k, m, j) {
        var l = g.replaceLocalFilename(h);
        return this.__innerSaveImage("SaveAsBMP", g.makeParams(l, k), m, j)
    };
    d.SaveAsJPEG = function(h, k, m, j) {
        var l = g.replaceLocalFilename(h);
        return this.__innerSaveImage("SaveAsJPEG", g.makeParams(l, k), m, j)
    };
    d.SaveAsPDF = function(h, k, m, j) {
        var l = g.replaceLocalFilename(h);
        return this.__innerSaveImage("SaveAsPDF", g.makeParams(l, k), m, j)
    };
    d.SaveAsPNG = function(h, k, m, j) {
        var l = g.replaceLocalFilename(h);
        return this.__innerSaveImage("SaveAsPNG", g.makeParams(l, k), m, j)
    };
    d.SaveAsTIFF = function(h, k, m, j) {
        var l = g.replaceLocalFilename(h);
        return this.__innerSaveImage("SaveAsTIFF", g.makeParams(l, k), m, j)
    };
    d.SaveAsGIF = function(h, k, m, j) {
        var l = g.replaceLocalFilename(h);
        return this.__innerSaveImage("SaveAsGIF", g.makeParams(l, k), m, j)
    };
    d.SaveSelectedImagesAsMultiPagePDF = function(j, m, k) {
        var n = this,
            l = g.replaceLocalFilename(j),
            h;
        h = g.__SetSelectedImages(n, n._UIManager.GetCurrentImageIndex(), n._UIManager.GetSelectedIndexes());
        if (h) {
            return n.__innerSaveImage("SaveSelectedImagesAsMultiPagePDF", g.makeParams(l), m, k)
        }
        return false
    };
    d.SaveSelectedImagesAsMultiPageTIFF = function(j, m, k) {
        var n = this,
            l = g.replaceLocalFilename(j),
            h;
        h = g.__SetSelectedImages(n, n._UIManager.GetCurrentImageIndex(), n._UIManager.GetSelectedIndexes());
        if (h) {
            return n.__innerSaveImage("SaveSelectedImagesAsMultiPageTIFF", g.makeParams(l), m, k)
        }
        return false
    };
    d.SaveSelectedImagesToBase64Binary = function(k, j) {
        var l = this,
            h;
        h = g.__SetSelectedImages(l, l._UIManager.GetCurrentImageIndex(), l._UIManager.GetSelectedIndexes());
        if (h) {
            if (b.isFunction(k)) {
                return this._innerSend("SaveSelectedImagesToBase64Binary", null, true, k, j)
            } else {
                return l._innerFun("SaveSelectedImagesToBase64Binary")
            }
        }
        return false
    };
    d.ShowFileDialog = function(l, j, r, q, p, h, k, s) {
        var n = this,
            m = g.replaceLocalFilename(p);
        return this._innerSend("ShowFileDialog", g.makeParams(l, j, r, q, m, h, k, s), true)
    };
    d.FTPDownload = function(n, l, k, h) {
        var m = this,
            j = b.html5.Funs.getImageType(l);
        return m.__innerFTPDownload("FTPDownload", g.makeParams(n, l), j, k, h)
    };
    d.FTPDownloadDirectly = function(q, n, h, m, j) {
        var p = this,
            k = g.replaceLocalFilename(h),
            l = b.html5.Funs.getImageType(k);
        return p.__innerFTPDownloadDirectly("FTPDownloadDirectly", g.makeParams(q, n, k), l, m, j)
    };
    d.FTPDownloadEx = function(m, l, j, k, h) {
    ...
    d.FTPUploadDirectly = function(p, h, m, l, j) {
        var n = this,
            k;
        if (!b.html5.Funs.checkProductKey(n, {
            ...
            if (b.isFunction(j)) {
                j(n._errorCode, n._errorString)
            }
            return false
        }
        k = g.replaceLocalFilename(h);
        return n.__innerFTPUpload("FTPUploadDirectly", g.makeParams(p, k, m), l, j)
    };
    d.FTPUploadEx = function(n, j, m, k, l, h) {
        return this.__innerFTPUpload("FTPUploadEx", g.makeParams(n, j, m, k), l, h)
    };
    d.FTPUploadAllAsMultiPageTIFF = function(l, k, j, h) {
        return this.__innerFTPUpload("FTPUploadAllAsMultiPageTIFF", g.makeParams(l, k), j, h)
    };
    d.FTPUploadAllAsPDF = function(l, k, j, h) {
        return this.__innerFTPUpload("FTPUploadAllAsPDF", g.makeParams(l, k), j, h)
    };
    d.FTPUploadAsMultiPagePDF = function(l, k, j, h) {
        return this.__innerFTPUpload("FTPUploadAsMultiPagePDF", g.makeParams(l, k), j, h)
    };
    d.FTPUploadAsMultiPageTIFF = function(l, k, j, h) {
        return this.__innerFTPUpload("FTPUploadAsMultiPageTIFF", g.makeParams(l, k), j, h)
    };
    d.HTTPDownload = function(k, j, m, h) {
        var n = this,
            l = g.getImageType(j);
        return n.HTTPDownloadThroughGet(k, j, l, m, h)
    };
    e.prototype.HTTPDownloadEx = function(k, j, l, m, h) {
        var n = this;
        return n.HTTPDownloadThroughGet(k, j, l, m, h)
    };
    d.HTTPDownloadDirectly = function(v, h, p, u, m) {
        var r = this,
            j = f.GetHttpHeadersAndClear(r),
            l = g.combineUrl(r, v, h),
            k, s, q;
        if (l === false) {
            b.Errors.ParameterCannotEmpty(r);
            return false
        }
        if (!p || p == "") {
            b.Errors.InvalidLocalFilename(r, "HTTPDownloadDirectly");
            if (b.isFunction(m)) {
                m(r.ErrorCode, r.ErrorString)
            }
            return false
        }
        k = b.html5.Funs.getImageType(p);
        if (g.isServerInvalid(r)) {
            if (b.isFunction(m)) {
                m(r.ErrorCode, r.ErrorString)
            }
            return false
        }
        if (!b.html5.Funs.checkProductKey(r, {
                Core: true
            })) {
            if (b.isFunction(m)) {
                m(r._errorCode, r._errorString)
            }
            return false
        }
        if (!b.html5.Funs.checkPDFProductKeyWhenNeeds(r, k)) {
            if (b.isFunction(m)) {
                m(r._errorCode, r._errorString)
            }
            return false
        ...
        b.cancelFrome = 2;
        q = g.replaceLocalFilename(p);
        s = "get";
        b.showProgress(r, "HTTPDownloadDirectly", true);
        var t = function(w) {
                var x = (w.total === 0) ? 100 : Math.round(w.loaded * 100 / w.total),
                    y = [w.loaded, " / ", w.total].join("");
                r._OnPercentDone([0, x, "", "http"])
            },
            n = true;
        r._OnPercentDone([0, -1, "HTTP Downloading...", "http"]);
        if (!b.isFunction(u)) {
            n = false
        }
        ret = g.loadHttpBlob(r, s, l, n, function(w) {
            r._OnPercentDone([0, -1, "Loading..."]);
            var x = 3;
            return r.__LoadImageFromBytes(w, x, q, n, u, m)
        }, function() {
            b.closeProgress("HTTPDownloadDirectly");
            if (b.isFunction(m)) {
                m(r.ErrorCode, r.ErrorString)
            }
            return false
    ...
    d.HTTPUploadThroughPostDirectly = function(w, r, h, p, v, n) {
        var t = this,
            j = f.GetHttpHeadersAndClear(t),
            k = "HTTPUploadThroughPostDirectly",
            l = g.combineUrl(t, w, h),
            q = true,
            s, u;
        if (w === "") {
            b.Errors.HttpServerCannotEmpty(t);
            if (b.isFunction(n)) {
                n(t.ErrorCode, t.ErrorString, "")
            }
            return false
        }
        if (l === false || l === "") {
            b.Errors.ParameterCannotEmpty(t);
            if (b.isFunction(n)) {
                n(t.ErrorCode, t.ErrorString, "")
            }
            return false
        ...
        if (!b.html5.Funs.checkProductKey(t, {
                Core: true
            })) {
            if (b.isFunction(n)) {
                n(t.ErrorCode, t.ErrorString, "")
        ...
        b.cancelFrome = 1;
        var x = function() {
            b.needShowTwiceShowDialog = false;
            b.closeProgress(k);
            if (b.isFunction(n)) {
                n(t.ErrorCode, t.ErrorString, t.__HTTPPostResponseString)
            }
            return false
        };
        b.needShowTwiceShowDialog = true;
        b.showProgress(t, k, false);
        s = g.replaceLocalFilename(r);
        u = t.__SaveLocalFileToBytes(s, q, function(m) {
            b.needShowTwiceShowDialog = false;
            if (m && (b.dlgRef > 0 || t.__IfShowCancelDialogWhenImageTransfer == false || q == false)) {
                m.name = p;
                g.setBtnCancelVisibleForProgress(t, true);
                return g.httpPostUpload(t, l, m, q, 0, j, true, function(y) {
                    b.closeProgress(k);
                    if (b.isFunction(v)) {
                        v(y)
                    }
    ...
    d.HTTPUploadThroughPost = function(l, k, h, p, n, j) {
        var m = g.getImageType(p);
        return this.HTTPUploadThroughPostEx(l, k, h, p, m, n, j)
    };
    d.HTTPUploadThroughPostEx = function(x, z, h, q, v, w, p) {
        var s = this,
            j = f.GetHttpHeadersAndClear(s),
            l = "HTTPUploadThroughPostEx",
            n = g.combineUrl(s, x, h),
            r = true,
            u = false,
            t = "",
            k = 0;
        ...
        b.cancelFrome = 1;
        var y = function() {
            var m = s.curCommand_SaveImagesToBytes.length;
            b.needShowTwiceShowDialog = false;
            b.closeProgress(l);
            if (b.isFunction(p)) {
                p(s.ErrorCode, s.ErrorString, s.__HTTPPostResponseString)
            }
            if (m > 0) {
                b.cancelFrome = 1;
                b.needShowTwiceShowDialog = true;
                b.showProgress(s, l, false);
                var A = s.curCommand_SaveImagesToBytes[0];
                g.sendData(A.objWS, A.json, false, A.binary)
            }
            return false
        };
        b.needShowTwiceShowDialog = true;
        b.showProgress(s, l, false);
        if (x === "") {
            b.Errors.HttpServerCannotEmpty(s);
            return y()
        }
        if (n === false) {
            b.Errors.ParameterCannotEmpty(s);
            return y()
        }
        if (z == -2) {
            u = g.__SetSelectedImages(s, s._UIManager.GetCurrentImageIndex(), s._UIManager.GetSelectedIndexes());
            if (!u) {
                return y()
            }
        } else {
            if (z == -1 || z >= 0) {} else {
                b.Errors.IndexOutOfRange(s);
                return y()
            }
        }
        u = s.__GetSelectedImagesLength(v, z, r, function(A) {
            var m = A.split(";");
            if (m.length == 2) {
                t = m[0];
                k = parseInt(m[1])
            ...
            if (k == 0) {
                b.Errors.UploadFileCannotEmpty(s);
                return y()
            }
            j["dwt-md5"] = t;
            u = s.__SaveSelectedImagesToBytes(v, 0, k, r, function(B) {
                b.needShowTwiceShowDialog = false;
                if (B && (b.dlgRef > 0 || s.__IfShowCancelDialogWhenImageTransfer == false || r == false)) {
                    B.name = q;
                    g.setBtnCancelVisibleForProgress(s, true);
                    return g.httpPostUpload(s, n, B, r, 0, j, true, function(C) {
                        var D = s.curCommand_SaveImagesToBytes.length;
                        b.closeProgress(l);
                        if (b.isFunction(w)) {
                            w(C)
                        }
                        if (D > 0) {
                            ...
                            b.needShowTwiceShowDialog = true;
                            b.showProgress(s, l, false);
                            var E = s.curCommand_SaveImagesToBytes[0];
                            g.sendData(E.objWS, E.json, false, E.binary)
                        }
                        return true
                    }, y)
                } else {
    ...
    d._checkIndices = function(l) {
        var m = this,
            h, j;
        if (!b.isArray(l)) {
            b.Errors.IndicesNotArray(m);
            return false
        }
        if (l.length == 0) {
            b.Errors.IndicesCannotEmpty(m);
            return false
        }
        h = m._HowManyImagesInBuffer;
        for (j = 0; j < l.length; j++) {
            var k = l[j];
            if (b.isUndefined(k) || k === null) {
            ...
            if (k < 0 || k >= h) {
                b.Errors.IndicesOutOfRange(m);
                return false
            }
        }
        return true
    };
    d.SetUploadSegment = function(h, j) {
        var k = this;
        if (!(h >= 0)) {
            b.Errors.InvalidSegmentUploadThreshold(k);
            return false
        }
        if (!(j > 0)) {
            b.Errors.InvalidModuleSize(k);
            return false
        }
        k._segementUploadThreshold = h * 1024 * 1024;
        k._moduleSize = j * 1024;
        return true
    };
    d.HTTPUpload = function(j, r, p, q, l, h) {
        var n = this,
            k;
        ...
        b._aryUploadCmd.push(k);
        return true
    };
    d._innerHTTPUpload = function(k, n, q, G, l, z) {
        var x = this,
            r = parseInt(q),
            B = parseInt(G),
            D, u = "HTTPUpload",
        ...
        if (b.isUndefined(p) || p === "") {
            b.Errors.ParameterCannotEmpty(x);
            return D()
        } else {
            if (!b.isString(p)) {
                b.Errors.InvalidUrl(x);
                return D()
            }
        }
        ...
        if (g.isServerInvalid(x)) {
            return D()
        }
        if (!x._checkIndices(n)) {
            return D()
        }
        if (r == EnumDWT_ImageType.IT_BMP || r == EnumDWT_ImageType.IT_JPG || r == EnumDWT_ImageType.IT_PNG) {
            if (n.length > 1) {
                b.Errors.UploadIndexMoreThanOne(x);
                return D()
            }
        } else {
            if (r == EnumDWT_ImageType.IT_TIF || r == EnumDWT_ImageType.IT_PDF) {} else {
                b.Errors.InvalidImageType(x);
                return D()
            }
        }
        if (B != EnumDWT_UploadDataFormat.Binary && B != EnumDWT_UploadDataFormat.Base64) {
            b.Errors.InvalidDataFormat(x);
            return D()
        }
        x.__HTTPPostResponseString = "";
        b.cancelFrome = 1;
        var h = function() {
            ...
            if (m > 0) {
                b.cancelFrome = 1;
                b.needShowTwiceShowDialog = true;
                b.showProgress(x, u, false);
                var I = x.curCommand_SaveImagesToBytes[0];
                g.sendData(I.objWS, I.json, false, I.binary)
            }
            if (b.isFunction(z)) {
                z(x.ErrorCode, x.ErrorString, x.__HTTPPostResponseString)
            }
        ...
        if (B == EnumDWT_UploadDataFormat.Binary) {
            var j = "",
                v = 0;
            H = g.__SetSelectedImages(x, x._UIManager.GetCurrentImageIndex(), n);
            if (!H) {
                return h()
            }
            b.needShowTwiceShowDialog = true;
            b.showProgress(x, u, false);
            H = x.__GetSelectedImagesLength(r, -2, A, function(I) {
                var m = I.split(";");
                if (m.length == 2) {
                    j = m[0];
                    v = parseInt(m[1])
                ...
                if (v == 0) {
                    b.Errors.UploadFileCannotEmpty(x);
                    return h()
                }
                if (E > 0 && v > E) {
                    var K = 0,
                        J = f.GetHttpHeadersAndClear(x);
                    J["dwt-md5"] = j;
                    x._OnPercentDone([0, -1, "HTTP Uploading...", "http"]);
                    H = f.UploadBinary(x, p, r, v, J, K, w, t, function() {
                        b.needShowTwiceShowDialog = false;
                        b.closeProgress(u);
                        if (b.isFunction(l)) {
                            l(x.__HTTPPostResponseString)
                        }
                        return true
                    }, h)
                } else {
                    H = x.__innnerHTTPUploadBinaryFull(p, j, v, r, l, h)
                }
                return H
            }, h)
        } else {
            if (B == EnumDWT_UploadDataFormat.Base64) {
                var F = g.addImageFileExt("RemoteFile", r);
                b.needShowTwiceShowDialog = true;
                b.showProgress(x, u, false);
                H = x.ConvertToBase64(n, r, function(K) {
                    if (!K || K.getLength() <= 0) {
                        b.Errors.UploadFileCannotEmpty(x);
                        return h()
                    }
                    if (E > 0 && K.getLength() > E) {
                        var L = 0,
                            J = K.getMD5(),
                            I = f.GetHttpHeadersAndClear(x);
                        I["dwt-md5"] = J;
                        x._OnPercentDone([0, -1, "HTTP Uploading...", "http"]);
                        f.UploadBase64(x, p, r, K, F, I, L, w, t, function() {
                            b.needShowTwiceShowDialog = false;
                            b.closeProgress(u);
                            if (b.isFunction(l)) {
                                l(x.__HTTPPostResponseString)
                        ...
                        x.__innnerHTTPUploadBase64Full(p, J, m, r, l, h)
                    }
                }, h)
            }
        }
    ...
    d._innerFormFieldHTTPUpload = function(j, q, h) {
        var s = this,
            l, n = "HTTPUpload",
            p = j,
            r = true,
        ...
        l = function() {
            ...
            b.closeProgress(n);
            if (b.isFunction(h)) {
                h(s.ErrorCode, s.ErrorString, s.__HTTPPostResponseString)
            }
            return false
        };
        if (b.isUndefined(p) || p === "") {
        ...
        if (g.isServerInvalid(s)) {
            return l()
        }
        s.__HTTPPostResponseString = "";
        b.cancelFrome = 1;
        b.showProgress(s, n, false);
        b.needShowTwiceShowDialog = true;
        var k = f.GetHttpHeadersAndClear(s);
        s._OnPercentDone([0, -1, "HTTP Uploading...", "http"]);
        t = g.httpUploadByBIO(s, p, c, 0, true, k, true, function(m) {
            b.needShowTwiceShowDialog = false;
            b.closeProgress(n);
            if (b.isFunction(q)) {
                q(m)
    ...
    var f = {
        UploadBinary: function(r, n, t, k, h, p, s, u, q, w) {
            var v, j, l = "HttpUpload";
            v = k - p;
            if (v > 0) {
                if (v >= s) {
                    v -= s;
                ...
                r.__SaveSelectedImagesToBytesByBlock(t, p, j, function(x, m) {
                    if (!x) {
                        b.Errors.UploadFileCannotEmpty(r);
                        return w()
                    }
                    if (b.dlgRef > 0 || r.__IfShowCancelDialogWhenImageTransfer == false) {
                        x.name = "RemoteFile";
                        g.setBtnCancelVisibleForProgress(r, true);
                        h["Content-Range"] = ["bytes ", m, "-", m + x.size - 1, "/", k].join("");
                        u({
                            total: k,
                            loaded: p
                        });
                        g.httpPostUpload(r, n, x, true, 0, h, false, function(y) {
                            ...
                            if (v == 0) {
                                ...
                                setTimeout(function() {
                                    b.cancelFrome = 1;
                                    f.UploadBinary(r, n, t, k, h, p, s, u, q, w)
                                }, 100)
                            }
                        }, w);
                        return true
                    } else {
                        b.Errors.UploadError(r, true);
                        return w()
                    }
                }, w)
            } else {
        ...
        UploadBase64: function(s, n, u, z, p, h, q, t, v, r, x) {
            var k = z.getLength(),
                l = "HttpUpload",
                w, j, y = 0;
            w = k - q;
            if (w > 0) {
                ...
                s.__GetBase64ResultDataAsync(-1, q, t, function(m) {
                    strBase64Data = m[0];
                    if (!strBase64Data || strBase64Data == "") {
                        b.Errors.UploadFileCannotEmpty(s);
                        return x()
                    }
                    if (b.dlgRef > 0 || s.__IfShowCancelDialogWhenImageTransfer == false) {
                        g.setBtnCancelVisibleForProgress(s, true);
                        h["Content-Range"] = ["bytes ", q, "-", q + j - 1, "/", k].join("");
                        v({
                            total: k,
                            loaded: q
                        });
                        g.httpPostUploadString(s, n, strBase64Data, p, 0, h, false, function(A) {
                            var B = s.curCommand_SaveImagesToBytes.length;
                            if (B > 0) {
                                b.cancelFrome = 1;
                                var C = s.curCommand_SaveImagesToBytes[0];
                                g.sendData(C.objWS, C.json, false, C.binary)
                            }
                            if (w == 0) {
                                b.needShowTwiceShowDialog = false;
                                v({
                                ...
                                setTimeout(function() {
                                    b.cancelFrome = 1;
                                    f.UploadBase64(s, n, u, z, p, h, q, t, v, r, x)
                                }, 100)
                            }
                        }, x);
                        return true
                    } else {
                        b.Errors.UploadError(s, true);
                        return x()
                    }
                }, x)
            } else {
        ...
        GetHttpHeadersAndClear: function(j) {
            var h = j.__httpHeaderMap;
            j.__httpHeaderMap = {};
            if (!h) {
                h = {}
            }
    ...
    d.__innnerHTTPUploadBinaryFull = function(k, j, w, q, l, h) {
        var v = this,
            s = f.GetHttpHeadersAndClear(v),
            t = "HTTPUpload",
            A, p = k,
            y = true,
            B = false,
            u = 0,
            x, z, r;
        A = g.addImageFileExt("RemoteFile", q);
        var n = 0;
        s["dwt-md5"] = j;
        B = v.__SaveSelectedImagesToBytesByBlock(q, n, w, function(C, m) {
            if (!C || C.size <= 0) {
                b.Errors.UploadFileCannotEmpty(v);
                return h()
            }
            if (b.dlgRef > 0 || v.__IfShowCancelDialogWhenImageTransfer == false) {
                C.name = A;
                g.setBtnCancelVisibleForProgress(v, true);
                return g.httpPostUpload(v, p, C, y, u, s, true, function(D) {
                    var E = v.curCommand_SaveImagesToBytes.length;
                    b.needShowTwiceShowDialog = false;
                    b.closeProgress(t);
                    if (b.isFunction(l)) {
                        l(D)
                    ...
                    if (E > 0) {
                        b.cancelFrome = 1;
                        b.needShowTwiceShowDialog = true;
                        b.showProgress(v, t, false);
                        var F = v.curCommand_SaveImagesToBytes[0];
                        g.sendData(F.objWS, F.json, false, F.binary)
                    }
                }, h)
            } else {
                b.Errors.UploadError(v, true);
                return h()
            }
        }, h);
        return B
    };
    d.__innnerHTTPUploadBase64Full = function(j, w, A, y, r, z) {
        var t = this,
            k = f.GetHttpHeadersAndClear(t),
            l = "HTTPUpload",
            p, n = j,
            s = true,
            v = false,
            u = 0,
            q, x, h;
        p = g.addImageFileExt("RemoteFile", y);
        b.needShowTwiceShowDialog = true;
        b.showProgress(t, l, false);
        if (b.dlgRef > 0 || t.__IfShowCancelDialogWhenImageTransfer == false) {
            if (k) {
                k["dwt-md5"] = w
            }
            g.setBtnCancelVisibleForProgress(t, true);
            return g.httpPostUploadString(t, n, A, p, 0, k, true, function(m) {
                var B = t.curCommand_SaveImagesToBytes.length;
                b.needShowTwiceShowDialog = false;
                b.closeProgress(l);
                if (b.isFunction(r)) {
                    r(m)
                ...
                if (B > 0) {
                    ...
                    b.needShowTwiceShowDialog = true;
                    b.showProgress(t, l, false);
                    var C = t.curCommand_SaveImagesToBytes[0];
                    g.sendData(C.objWS, C.json, false, C.binary)
                }
            }, z)
        } else {
            b.Errors.UploadError(t, true);
            return z()
        }
        return v
    };
    d.ConvertToBase64 = function(s, q, l, h) {
        var n = this,
            j = parseInt(q),
            k = "SaveSelectedImagesToBase64Binary",
            p;
        if (g.isServerInvalid(n)) {
            if (b.isFunction(h)) {
                h(n.ErrorCode, n.ErrorString)
            }
            return false
        }
        if (!n._checkIndices(s)) {
            if (b.isFunction(h)) {
                h(n.ErrorCode, n.ErrorString)
            }
            return false
        }
        if (j == EnumDWT_ImageType.IT_BMP || j == EnumDWT_ImageType.IT_JPG || j == EnumDWT_ImageType.IT_PNG) {
            if (s.length > 1) {
                b.Errors.ConvertBase64IndexMoreThanOne(n);
                if (b.isFunction(h)) {
                    h(n.ErrorCode, n.ErrorString)
                }
                return false
            ...
            if (j == EnumDWT_ImageType.IT_TIF || j == EnumDWT_ImageType.IT_PDF) {} else {
                b.Errors.InvalidImageType(n);
                if (b.isFunction(h)) {
                    h(n.ErrorCode, n.ErrorString)
                }
                return false
        ...
        p = g.__SetSelectedImages(n, n._UIManager.GetCurrentImageIndex(), s);
        if (!p) {
            if (b.isFunction(h)) {
                h(n.ErrorCode, n.ErrorString)
            }
        ...
        p = n._innerSend(k, g.makeParams(j, 0, 0), true, function(w) {
            var t, m = 0,
                v = "",
                u;
            if (n.ErrorCode != 0) {
            ...
            if (w && b.isArray(w) && w.length == 1) {
                u = w[0].split(";");
                if (u.length == 2) {
                    v = u[0];
                    m = parseInt(u[1])
                }
                t = new b.html5.Base64Result(n, m, v);
                b.closeProgress(k);
                if (b.isFunction(l)) {
                    l(t)
                }
            } else {
                b.Errors.ConvertBase64Failed(n);
                r()
            }
        }, r);
        return p
    };
    d.ClearAllHTTPFormField = function() {
        var h = this;
        h.httpFormFields = {};
        return true
    };
    d.SetHTTPFormField = function(m, h, k) {
        var l = this,
            j = m;
        if (!b.isString(j)) {
            j = "" + j
        ...
        l.httpFormFields[j] = h;
        return true
    };
    d.HTTPUploadAllThroughPostAsMultiPageTIFF = function(l, h, p, n, k) {
        var j = -1,
            m = 2;
        return this.HTTPUploadThroughPostEx(l, j, h, p, m, n, k)
    };
    d.HTTPUploadThroughPostAsMultiPageTIFF = function(l, h, q, n, k) {
        var p = this,
            j = -2,
            m = 2;
        return p.HTTPUploadThroughPostEx(l, j, h, q, m, n, k)
    };
    d.HTTPUploadAllThroughPostAsPDF = function(l, h, q, n, k) {
        var p = this,
            j = -1,
            m = 4;
        return this.HTTPUploadThroughPostEx(l, j, h, q, m, n, k)
    };
    d.HTTPUploadThroughPostAsMultiPagePDF = function(l, h, q, n, k) {
        var p = this,
            j = -2,
            m = 4;
        return p.HTTPUploadThroughPostEx(l, j, h, q, m, n, k)
    };
    d.HTTPDownloadThroughPost = function(u, h, k, t, m) {
        var p = this,
            j = f.GetHttpHeadersAndClear(p),
            l = g.combineUrl(p, u, h),
            r, q;
        if (l === c) {
            b.Errors.ParameterCannotEmpty(p);
            return c
        }
        if (g.isServerInvalid(p)) {
            if (b.isFunction(m)) {
                m(p.ErrorCode, p.ErrorString)
            }
            return c
        }
        if (!b.html5.Funs.checkProductKey(p, {
            ...
            if (b.isFunction(m)) {
                m(p._errorCode, p._errorString)
            }
            return c
        }
        if (!b.html5.Funs.checkPDFProductKeyWhenNeeds(p, k)) {
            if (b.isFunction(m)) {
                m(p._errorCode, p._errorString)
            }
            return c
        ...
        b.cancelFrome = 2;
        b.showProgress(p, "HttpDownloadThroughPost", a);
        r = "post";
        var s = function(v) {
        ...
        q = g.loadHttpBlob(p, r, l, n, function(v) {
            ...
            p.__LoadImageFromBytes(v, w, x, n, t, m)
        }, function() {
    ...
    d.HTTPDownloadThroughGet = function(u, h, k, t, m) {
        var p = this,
            j = f.GetHttpHeadersAndClear(p),
            l = g.combineUrl(p, u, h),
            r, q;
        ...
        b.cancelFrome = 2;
        r = "get";
        b.showProgress(p, "HTTPDownloadThroughGet", a);
        var s = function(v) {
                var w = (v.total === 0) ? 100 : Math.round(v.loaded * 100 / v.total),
                    x = [v.loaded, " / ", v.total].join("");
                p._OnPercentDone([0, w, "", "http"])
    ...
    d.HTTPUploadThroughPut = function(l, k, h, n, j) {
        var m = g.getImageType(h);
        return this.HTTPUploadThroughPutEx(l, k, h, m, n, j)
    };
    d.HTTPUploadThroughPutEx = function(v, x, t, r, u, l) {
        var p = this,
            h = f.GetHttpHeadersAndClear(p),
            j = "HTTPUploadThroughPutEx",
            k = g.combineUrl(p, v, t),
            n = true,
            q = false;
        if (k === false) {
            b.Errors.ParameterCannotEmpty(p);
        ...
        var w = function() {
                ...
                if (m > 0) {
                    b.cancelFrome = 1;
                    b.needShowTwiceShowDialog = true;
                    b.showProgress(p, j, false);
                    var y = p.curCommand_SaveImagesToBytes[0];
                    g.sendData(y.objWS, y.json, false, y.binary)
                }
                return false
            },
            s;
        ...
        b.showProgress(p, j, false);
        if (v === "") {
            b.Errors.HttpServerCannotEmpty(p);
            return w()
        }
        if (x == -2) {
            q = g.__SetSelectedImages(p, p._UIManager.GetCurrentImageIndex(), p._UIManager.GetSelectedIndexes());
            if (!q) {
                return w()
            }
        } else {
            if (x == -1 || x >= 0) {} else {
                b.Errors.IndexOutOfRange(p);
                return w()
            }
        }
        q = p.__GetSelectedImagesLength(r, x, n, function(y) {
            var m = y.split(";");
            if (m.length == 2) {
                md5 = m[0];
                iLen = parseInt(m[1])
            ...
            h["dwt-md5"] = md5;
            q = p.__SaveSelectedImagesToBytes(r, 0, iLen, n, function(z) {
                b.needShowTwiceShowDialog = false;
                if (z && (b.dlgRef > 0 || p.__IfShowCancelDialogWhenImageTransfer == false || n == false)) {
                    s = function(A) {
                        var B = (A.total === 0) ? 100 : Math.round(A.loaded * 100 / A.total),
                            C = [A.loaded, " / ", A.total].join("");
                        p._OnPercentDone([0, B, "", "http"])
                    };
                    p._OnPercentDone([0, -1, "uploading...", "http"]);
                    g.setBtnCancelVisibleForProgress(p, true);
                    return g.httpPutImage(p, k, z, n, function(A) {
                        var B = p.curCommand_SaveImagesToBytes.length;
                        p.__HTTPPostResponseString = A;
                        b.closeProgress(j);
                        if (b.isFunction(u)) {
                        ...
                        if (B > 0) {
                            ...
                            b.needShowTwiceShowDialog = true;
                            b.showProgress(p, j, false);
                            var C = p.curCommand_SaveImagesToBytes[0];
                            g.sendData(C.objWS, C.json, false, C.binary)
                        }
                        return true
                    }, w, s)
    ...
    d.HTTPUploadAllThroughPutAsMultiPageTIFF = function(l, h, n, k) {
        var j = -1,
            m = 2;
        return this.HTTPUploadThroughPutEx(l, j, h, m, n, k)
    };
    d.HTTPUploadThroughPutAsMultiPageTIFF = function(l, h, n, k) {
        var p = this,
            j = -2,
            m = 2;
        return p.HTTPUploadThroughPutEx(l, j, h, m, n, k)
    };
    d.HTTPUploadAllThroughPutAsPDF = function(l, h, n, k) {
        var j = -1,
            m = 4;
        return this.HTTPUploadThroughPutEx(l, j, h, m, n, k)
    };
    d.HTTPUploadThroughPutAsMultiPagePDF = function(l, h, n, k) {
        var p = this,
            j = -2,
            m = 4;
        return p.HTTPUploadThroughPutEx(l, j, h, m, n, k)
    };
    d.GetSelectedImagesSize = function(j) {
        var k = this,
            h;
        h = g.__SetSelectedImages(k, k._UIManager.GetCurrentImageIndex(), k._UIManager.GetSelectedIndexes());
        if (h) {
            return this._innerFun("GetSelectedImagesSize", g.makeParams(j))
        }
        return false
    };
    d.SetHTTPHeader = function(l, n) {
        var p = this,
            h, k, j, m = l;
        ...
        if (!m || !b.isString(m)) {
            if (b.isUndefined(m)) {
                b.Errors.HttpHeaderIsUndefined(p)
            } else {
                if (m === "") {
                    b.Errors.HttpHeaderIsEmpty(p)
                } else {
                    if (m === null) {
                        b.Errors.HttpHeaderIsNull(p)
                    } else {
                        b.Errors.HttpHeaderIsInvalid(p)
                    }
                }
            }
            return false
        }
        k = ["if-modified-since", "if-none-match", "if-range", "range", "accept-charset", "accept-encoding", "access-control-request-headers", "access-control-request-method", "connection", "content-length", "cookie", "cookie2", "date", "dnt", "expect", "host", "keep-alive", "origin", "referer", "te", "trailer", "transfer-encoding", "upgrade", "user-agent", "via", "dwt-md5"];
        m = m.toLowerCase();
        for (j = 0; j < k.length; j++) {
            if (k[j] == m) {
                b.Errors.HttpHeaderNotAllowed(p);
                return false
            }
        }
        if (b.isUndefined(n) || n === null || n === "") {
            if (l in p.__httpHeaderMap) {
                delete p.__httpHeaderMap[l]
            }
            return true
        }
        if (b.isNumber(n)) {
        ...
        p.__httpHeaderMap[l] = n;
        return true
    };
    d.__GetBase64ResultData = function(h, k, j) {
        return this._innerFun("SaveSelectedImagesToBase64Binary", g.makeParams(h, k, j))
    };
    d.__GetBase64ResultDataAsync = function(h, l, k, j, m) {
        return this._innerFunRaw("SaveSelectedImagesToBase64Binary", g.makeParams(h, l, k), true, false, false, j, m)
    };
    b.html5.Base64Result = function(h, k, j) {
        var l = this;
        l._stwain = h;
        l._md5 = j;
        l._length = k
    };
    b.html5.Base64Result.prototype.getLength = function() {
        return this._length
    };
    b.html5.Base64Result.prototype.getMD5 = function() {
        return this._md5
    };
    b.html5.Base64Result.prototype.getData = function(l, j) {
        var m = this,
            h = j,
            k = -1;
        if (l < 0 || j <= 0) {
        ...
        return m._stwain.__GetBase64ResultData(k, l, h)
    };
    d.ConvertToBlob = function(v, t, n, h) {
        var q = this,
            k = parseInt(t),
            l = "ConvertToBlob",
            p = true,
        ...
        if (g.isServerInvalid(q)) {
            if (b.isFunction(h)) {
                h(q.ErrorCode, q.ErrorString)
            }
            return false
        }
        ...
        if (k == EnumDWT_ImageType.IT_BMP || k == EnumDWT_ImageType.IT_JPG || k == EnumDWT_ImageType.IT_PNG) {
            if (v.length > 1) {
                b.Errors.ConvertBinaryIndexMoreThanOne(q);
                if (b.isFunction(h)) {
                    h(q.ErrorCode, q.ErrorString)
                }
                return false
        ...
        var u = function() {
            ...
            if (m > 0) {
                ...
                g.sendData(w.objWS, w.json, false, w.binary)
            }
            return false
        };
        s = g.__SetSelectedImages(q, q._UIManager.GetCurrentImageIndex(), v);
        if (!s) {
            u();
            return false
        }
        s = q.__GetSelectedImagesLength(k, -2, p, function(w) {
            var m = w.split(";");
            if (m.length == 2) {
                r = m[0];
                j = parseInt(m[1])
            }
            s = q.__SaveSelectedImagesToBytes(k, 0, j, p, function(z) {
                b.needShowTwiceShowDialog = false;
                b.closeProgress(l);
                if (b.isFunction(n)) {
                    if (z instanceof Blob) {
                        var y = g.getBlobTypeByImageType(k);
                        n(z.slice(0, j, y))
                    } else {
                        n(z)
                    }
                }
                var x = q.curCommand_SaveImagesToBytes.length;
                if (x > 0) {
                    b.cancelFrome = 0;
                    b.needShowTwiceShowDialog = true;
                    b.showProgress(q, l, false);
    ...
    b._aryUploadCmd = [];
    b._asyUploadLoop = function() {
        if (b._aryUploadCmd.length == 0) {
            setTimeout(b._asyUploadLoop, 500);
            return
        }
        var k = b._aryUploadCmd[0];
        b._aryUploadCmd.splice(0, 1);
        var n = k._this,
            l = k.bOnlyUploadForm,
            j = k.url,
            m = k.asyncSuccessFunc,
            h = k.asyncFailureFunc;
        if (l) {
            n._innerFormFieldHTTPUpload(j, function() {
                if (b.isFunction(m)) {
                    try {
                        m(n.__HTTPPostResponseString)
                    } catch (s) {}
                }
                setTimeout(b._asyUploadLoop, 0)
            }, function() {
                if (b.isFunction(h)) {
                    try {
                        h(n.ErrorCode, n.ErrorString, n.__HTTPPostResponseString)
                    } catch (s) {}
                }
                setTimeout(b._asyUploadLoop, 0)
            })
            ...
            var r = k.indices,
                p = k.enumImageType,
                q = k.dataFormat;
            n._innerHTTPUpload(j, r, p, q, function() {
                if (b.isFunction(m)) {
                    try {
                        m(n.__HTTPPostResponseString)
                    } catch (s) {}
...
(function(a) {
    ...
    b._OnPostLoad = function(m, e) {
        var k = this,
            j, q, l, g, n, h;
        if (e !== undefined && e.exception !== undefined && e.description !== undefined) {
            k._errorCode = e.exception;
            k._errorString = e.description
        }
        Dynamsoft.Lib.log("OnPostLoad Results:");
        g = m[1].split(",");
        q = Dynamsoft.Lib.base64.decode(g[0]);
        n = Dynamsoft.Lib.base64.decode(g[1]);
        Dynamsoft.Lib.log(q);
        Dynamsoft.Lib.log(n);
        Dynamsoft.Lib.log(g[2]);
        d.autoDiscardBlankImage(k, "On PostLoad");
        h = k.__cIndex;
        if (h >= 0) {
            k.OnRefreshUI(h)
        }
        if (Dynamsoft.Lib.isFunction(k.__OnPostLoad)) {
            k.__OnPostLoad(q, n, g[2])
        }
    };
    ...
    b._OnPercentDone = function(p) {
        ...
        if ((Dynamsoft.Lib.cancelFrome == 0 && j.__IfShowProgressBar == true) || (Dynamsoft.Lib.cancelFrome != 0 && j.__IfShowCancelDialogWhenImageTransfer == true)) {
            var n = Dynamsoft.Lib.one(".dynamsoft-progressBar"),
                h = Dynamsoft.Lib.one(".dynamsoft-status"),
                e = Dynamsoft.Lib.one(".dynamsoft-finalMessage"),
                k = 0,
                l;
            ...
            if (k || k === 0) {
                ...
                if (n) {
                    if (Dynamsoft.Lib.env.bIE) {
                        if (n[0].objProgressBar) {
                            n[0].objProgressBar.setValue(k)
                        } else {
                            n[0].value = k
                        }
                    } else {
    ...
    b._OnGetFilePath = function(g) {
        var m = this,
            h, k, l, j, e;
        l = g[1].split(",");
        Dynamsoft.Lib.log("On GetFilePath Results:" + g);
        j = Dynamsoft.Lib.base64.decode(l[3]);
        e = Dynamsoft.Lib.base64.decode(l[4]);
        if (Dynamsoft.Lib.isFunction(m.__OnGetFilePath)) {
            m.__OnGetFilePath(l[0], l[1], l[2], j, e)
        }
    };
...
(function(b) {
    ...
    e.HTTPUploadThroughPutDirectly = function(l, j, h, m, k) {
        b.Errors.HTML5NotSupport(this);
        return false
    };
...
(function(c) {
    ...
    a.prototype.__init = function(f) {
        ...
        h.divTag.className = "dynamsoft-dwt-imgTag";
    ...
    a.prototype.__resetTag = function() {
        ...
        if (f.bShowPageNumber) {
            ...
            if (f.bSelect) {
                f.divTag.className = "dynamsoft-dwt-imgTag dynamsoft-dwt-imgTag_Selected"
            } else {
                f.divTag.className = "dynamsoft-dwt-imgTag dynamsoft-dwt-imgTag_Normal"
            }
...
(function(a) {
    ...
    Funs2 = {
        ...
        print: function(v) {
            ...
            for (A = 0; A < v.length; A++) {
                ...
                q += x;
                l += m;
                z = z + '<div style="width:850px;height:' + s + 'px"> <img id="D_img' + A + '" src="' + r + '" style="position:relative;left:0px;top:0px;width: ' + B + "px;height: " + n + 'px" /></div>'
            }
            var D, y = ["alwaysRaised=yes,z-look=yes,top=0,left=0,toolbar=no,menubar=no,location=no,status=no,width=", q, ",height=", l].join(""),
                k = '<html><body id="D_img">' + z + "</body></html>";
            var C = window.open("about:blank", "_blank", y);
            if (C) {
                C.document.write(k);
                C.document.close();
                C.focus();
                D = C.document.getElementById("D_img");
                if (D) {
                    D.onload = function() {
                        C.print();
                        C.close();
    ...
    f.prototype.__SetArrayControlLoadImage = function(n, m, u, r, l, k, t, p) {
        var s = this;
        var q = 0;
        for (q = 0; q < a.aryControlLoadImage.length; q++) {
            var v = a.aryControlLoadImage[q];
        ...
        a.aryControlLoadImage.push(new d(n, m, s, u, r, l, k, t, p, s.BaseUrl))
    };
    ...
    a.AttachAndShowImage = function() {
        ...
        var m = 0;
        var p = a.aryControlLoadImage[0];
        a.aryControlLoadImage.splice(0, 1);
        if (p.iControlIndex >= 0 && p.iControlIndex < a.imageControlCount) {
            var l = 2,
                k = p.iWidth,
                n = p.iHeight;
            if (k > l) {
            ...
            if (p.bOnlyFromServer) {
                a.OnGetImageFromServer(p, p.modelImageControl, p.iImageIndex, k, n, p.BaseUrl, p.AttachImagesForControl)
            } else {
                a.OnGetImageByURL(p, p.modelImageControl, p.iImageIndex, k, n, p.BaseUrl, p.AttachImagesForControl)
            }
        } else {
            setTimeout(a.AttachAndShowImage, 0)
        }
    };
    a.OnGetImageByURL = function(u, m, q, s, p, r, l) {
        var k, t, n = u.imgControl;
        if (l) {
            if (m.imageUrl && m.imageUrl != "") {
                ...
                t.onload = function() {
                    n.tmpImage = false;
                    m.imageToShow = t;
                    m.imageWidth = t.width;
                    m.imageHeight = t.height;
                    m.iImageControlWidth = s;
                    m.iImageControlHeight = p;
                    m.bIsDirty = false;
                    l(n, m, q);
                    t.onload = undefined;
                    t.onerror = undefined;
                ...
                t.onerror = function(w) {
                    var x = n.GetBindIndex(),
                        y = u.View,
                        v;
                    v = y.GetDataImageControlList().length;
                    if (x >= 0 && x < v) {
                        t.src = m.imageUrl
                    } else {
                        t.src = "data:,";
                ...
                a.OnGetImageFromServer(u, m, q, s, p, r, l)
            }
        } else {
            setTimeout(a.AttachAndShowImage, 0)
        }
    ...
    a.OnGetImageFromServer = function(u, m, q, s, p, r, l) {
        var k, t, n = u.imgControl;
        if (l && r) {
            n.ClearImage();
            n.SetBindIndex(q);
            k = Funs2.getImageUrl(r, q, s, p);
            t = new Image();
            t.src = k;
            t.onload = function() {
                n.tmpImage = false;
            ...
            t.onerror = function(w) {
                ...
                v = y.GetDataImageControlList().length;
                if (x >= 0 && x < v) {
                    k = Funs2.getImageUrl(r, n.GetBindIndex(), s, p);
                    t.src = k
                } else {
                    t.src = "data:,";
                    t.onload = undefined;
...
(function(c) {
    ...
    var f = "eng",
        ...
        e = {
            ...
            __createButton: function(m, h, l, g, k) {
                ...
                j.className = "dynamsoft-dwt-Editor_Buttons_" + h;
                j.title = l;
                j.style.width = g + "px";
                j.style.height = k + "px";
    ...
    function a(k, h) {
        var m = this,
            j = h || {},
            g, l = '<div class="D_ImageUIEditor dynamsoft-dwt-noPaddingnoMarginInside dynamsoft-dwt-thinborder"></div>';
        m._UIManager = k;
    ...
    a.prototype.__NewAryModelImageControl = function(j) {
        ...
        for (h = 0; h < j.length; h++) {
            var g = new c.UI.ModelImageControl();
            g.bIsDirty = true;
            g.imageToShow = null;
            g.imageWidth = -1;
            g.imageHeight = -1;
    ...
    a.prototype.updateEditor = function() {
        ...
        if (p.toolbar.self) {
            ...
            if (p.toolbar.width + p.toolbar.height == 0) {
                e.addClass(p.toolbar.self, "dynamsoft-dwt-notdisplayed")
            } else {
                ...
                if (!p.toolbar.filled) {
                    ...
                    if (p._IfImageChanged) {
                        var k = c.one(p.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_save"),
                            n = c.one(p.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_restore");
                        k[0].style.display = "";
                        n[0].style.display = ""
                    }
                }
                e.removeClass(p.toolbar.self, "dynamsoft-dwt-notdisplayed");
                e.removeClass(p.toolbar.self, "dynamsoft-dwt-overlay")
            }
            ...
            var l, m, j = ["D_ImageUIEditor", "dynamsoft-dwt-noPaddingnoMarginInside", "dynamsoft-dwt-thinborder"];
            l = document.createElement("div");
            l.id = "dynamsoft-dwt-viewerToolbar" + g;
            l.style.width = p.toolbar.width + "px";
            l.style.height = p.toolbar.height + "px";
            l.style.whiteSpace = "normal";
            l.className = "dynamsoft-dwt-viewerToolbar";
            ...
            h.onImageAreaSelected = function(s) {
                ...
                p.Right = s.right;
                p.Bottom = s.bottom;
                var r = c.one(p.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_crop");
                if (r && r[0]) {
                    var q = r[0].src;
            ...
            p._UIView = new c.UI.ImageUIView(h);
            ...
            p.toolbar.self = document.getElementById("dynamsoft-dwt-viewerToolbar" + g);
            p.updateEditor()
        }
    };
    a.prototype.updateMode = function(k) {
        var l = this,
            j;
        var h = c.one(l.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_next"),
            g = c.one(l.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_previous");
    ...
    a.prototype.CloseImageEditor = function() {
        var g = this;
        c.hide("dynamsoft_ImgSizeEditor");
        c.hide("dynamsoft_RotateAnyAngle");
    ...
    a.prototype.previous_btn = function() {
        var j = this,
            g, h = c.one(j.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_previous");
        if (h && h[0]) {
            g = h[0].src;
            if (g.indexOf("grey") != -1) {
                return
    ...
    a.prototype.next_btn = function() {
        var j = this,
            g, h = c.one(j.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_next");
        if (h && h[0]) {
            g = h[0].src;
            if (g.indexOf("grey") != -1) {
                return
    ...
    a.prototype.__goInner = function(k) {
        ...
        var h = c.one(l.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_previous"),
            g = c.one(l.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_next");
        if (k == 0) {
            if (h && h[0]) {
                var j = h[0].src;
                j = j.replace("previous.", "previous_grey.");
    ...
    a.prototype.RotateAnyAngle = function(m) {
        var j = this;
        c.hide("dynamsoft_ImgSizeEditor");
        if (!c.get("dynamsoft_RotateAnyAngle")) {
            var p = ['<div id="dynamsoft_RotateAnyAngle" class="dynamsoft-dwt-imgSizeEditor" style="display:none; z-index: 99999;">', "<ul>", '<li><label for="dynamsoft_Angle"><b>Angle :</b>', '<input type="text" id="dynamsoft_Angle" style="width:50%;" size="10"/></label></li>', '<li><label for="dynamsoft_Angle_InterpolationMethod"><b>Interpolation:</b>&nbsp;', '<select size="1" id="dynamsoft_Angle_InterpolationMethod"><option value = ""></option></select></li>', '<li><label for="dynamsoft_KeepSize"><b></b>', '<input type="checkbox" id="dynamsoft_KeepSize"/>Keep size</label></li>', "</ul>", "<div>", '<input id="dynamsoft_btnRotateAnyAngleOK" type="button" value="  OK  "/>', '<span><input id= "dynamsoft_btnCancelRotateAnyAngle" type="button" value="Cancel" /></span>', "</div>", "</div>"];
            c.one("body").append(p.join(""))
        }
        var q = c.get("dynamsoft_Angle_InterpolationMethod");
        q.options.length = 0;
        q.options.add(new Option("NearestNeighbor", 1));
        q.options.add(new Option("Bilinear", 2));
        q.options.add(new Option("Bicubic", 3));
        var k = c.get("dynamsoft_btnRotateAnyAngleOK");
        k.onclick = function() {
            var u = c.get("dynamsoft_Angle").value;
            c.get("dynamsoft_Angle").className = "";
            re = /^\d+$/;
            if (!re.test(u) || u <= 0) {
                c.get("dynamsoft_Angle").className += " invalid";
                c.get("dynamsoft_Angle").focus();
                alert("Error: The angle you entered is invalid.");
                return
            }
            var t = c.get("dynamsoft_KeepSize");
            var s = t.checked;
            var r = j.RotateEx(u, s, c.get("dynamsoft_Angle_InterpolationMethod").selectedIndex + 1);
            if (j._stwain.ErrorCode == 0) {
                c.hide("dynamsoft_RotateAnyAngle");
                return
            }
        };
        var h = c.get("dynamsoft_btnCancelRotateAnyAngle");
        h.onclick = function() {
            c.hide("dynamsoft_RotateAnyAngle")
        };
        var g = c.get("dynamsoft_RotateAnyAngle");
        c.toggle("dynamsoft_RotateAnyAngle");
        var l = m.y;
        if (!l) {
            l = m.offsetTop + 1
        }
        ...
        c.get("dynamsoft_Angle").value = "45"
    };
    ...
    a.prototype.ChangeImageSizeGetinput = function(m) {
        ...
        if (!c.get("dynamsoft_ImgSizeEditor")) {
            var p = ['<div id="dynamsoft_ImgSizeEditor" class="dynamsoft-dwt-imgSizeEditor" style="display:none;z-index: 99999;">', "<ul>", '<li><label for="dynamsoft_img_height"><b>New Height :</b>', '<input type="text" id="dynamsoft_img_height" style="width:50%;" size="10"/>pixel</label></li>', '<li><label for="dynamsoft_img_width"><b>New Width :</b>&nbsp;', '<input type="text" id="dynamsoft_img_width" style="width:50%;" size="10"/>pixel</label></li>', "<li>Interpolation method:", '<select size="1" id="dynamsoft_InterpolationMethod"><option value = ""></option></select></li>', "</ul>", "<div>", '<input id="dynamsoft_btnChangeImageSizeOK" type="button" value="  OK  "/>', '<span><input id= "dynamsoft_btnCancelChange" type="button" value="Cancel" /></span>', "</div>", "</div>"];
            c.one("body").append(p.join(""))
        }
        var q = c.get("dynamsoft_InterpolationMethod");
        q.options.length = 0;
        q.options.add(new Option("NearestNeighbor", 1));
        q.options.add(new Option("Bilinear", 2));
        q.options.add(new Option("Bicubic", 3));
        var g = c.get("dynamsoft_btnChangeImageSizeOK");
        g.onclick = function() {
            var t = c.get("dynamsoft_img_width").value,
                r = c.get("dynamsoft_img_height").value;
            c.get("dynamsoft_img_width").className = "";
            c.get("dynamsoft_img_height").className = "";
            re = /^\d+$/;
            if (!re.test(r) || r <= 0) {
                c.get("dynamsoft_img_height").className += " invalid";
                c.get("dynamsoft_img_height").focus();
                alert("Error: The height you entered is invalid.");
                return
            }
            if (!re.test(t) || t <= 0) {
                c.get("dynamsoft_img_width").className += " invalid";
                c.get("dynamsoft_img_width").focus();
                alert("Error: The width you entered is invalid.");
                return
            }
            var s = j.ChangeImageSize(t, r, c.get("dynamsoft_InterpolationMethod").selectedIndex + 1);
            if (j._stwain.ErrorCode == 0) {
                c.hide("dynamsoft_ImgSizeEditor");
                return
            }
        };
        var k = c.get("dynamsoft_btnCancelChange");
        k.onclick = function() {
            c.hide("dynamsoft_ImgSizeEditor")
        };
        var h = c.get("dynamsoft_ImgSizeEditor");
        ...
        if (j.aryModelImageControl[j.cIndex].imageToShow) {
            c.get("dynamsoft_img_width").value = j.aryModelImageControl[j.cIndex].imageToShow.width;
            c.get("dynamsoft_img_height").value = j.aryModelImageControl[j.cIndex].imageToShow.height
        } else {
            c.get("dynamsoft_img_width").value = 0;
            c.get("dynamsoft_img_height").value = 0
        }
        return false
    };
    a.prototype.Crop_btn = function() {
        var j = this,
            g, h = c.one(j.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_crop");
        if (h && h[0]) {
            g = h[0].src;
            if (g.indexOf("grey") != -1) {
                return
    ...
    a.prototype.__EnableMouseShapButtons = function(p) {
        var j = this,
            ...
            q, m, k;
        if (n) {
            var g = n.one(".dynamsoft-dwt-Editor_Buttons_hand"),
                h = n.one(".dynamsoft-dwt-Editor_Buttons_rectselect"),
                l = n.one(".dynamsoft-dwt-Editor_Buttons_zoom");
            e.removeClass(g.parent(), "dynamsoft-dwt-EditorButton-selected");
            e.removeClass(h.parent(), "dynamsoft-dwt-EditorButton-selected");
            e.removeClass(l.parent(), "dynamsoft-dwt-EditorButton-selected");
            if (p == EnumDWT_MouseShape.Hand) {
                e.addClass(g.parent(), "dynamsoft-dwt-EditorButton-selected")
            } else {
                if (p == EnumDWT_MouseShape.Crosshair) {
                    e.addClass(h.parent(), "dynamsoft-dwt-EditorButton-selected")
                } else {
                    if (p == EnumDWT_MouseShape.Zoom) {
                        e.addClass(l.parent(), "dynamsoft-dwt-EditorButton-selected")
                    }
                }
            }
        }
    ...
    a.prototype.__RestoreImageInner = function(k, h, n) {
        ...
        var j = function(s, v, t) {
            ...
            var r = c.one(p.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_save"),
                u = c.one(p.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_restore");
            if (r && r[0]) {
    ...
    a.prototype.__SaveImageInner = function(j, m) {
        ...
        var h = function(r, u, s) {
            ...
            var q = c.one(n.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_save"),
                t = c.one(n.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_restore");
            if (q && q[0]) {
    ...
    a.prototype.ShowDialogForSaveImage = function(h, l) {
        var m = this;
        var j = ['<div id="dynamsoft_waiting">', '<P style="white-space:nowrap;">', "You have changed the image, do you want to keep the change(s)?", "</P>", '<div style="width: 200px;white-space:nowrap;margin-left: auto;margin-right: auto;">', '<input id="dynamsoft_btnSave" style="width: 100px; height:30px; margin-right: 10px; margin-top: 10px;"  type="button" value="  OK  "/>', '<input id= "dynamsoft_btnCancel" style="width: 100px; height:30px;"  type="button" value="  NO  " />', "</div>", "</div>"];
        Dynamsoft.WebTwainEnv.ShowDialog(422, 107, j.join(""), true);
        var g = c.get("dynamsoft_btnSave");
        g.onclick = function() {
        ...
        var k = c.get("dynamsoft_btnCancel");
        k.onclick = function() {
    ...
    a.prototype.__SetCropButtonGrey = function(j) {
        ...
        l.Right = 0;
        l.Bottom = 0;
        var k = c.one(l.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_crop");
        if (k && k[0]) {
            var h = k[0].src;
    ...
    a.prototype.__SetZoomInButtonEnable = function(g) {
        var k = this;
        var j = c.one(k.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_zoomin");
        if (j && j[0]) {
            var h = j[0].src;
            if (g == true) {
    ...
    a.prototype.__SetZoomOutButtonEnable = function(g) {
        var k = this;
        var j = c.one(k.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_zoomout");
        if (j && j[0]) {
            var h = j[0].src;
            if (g == true) {
    ...
    a.prototype.refresh = function(j) {
        ...
        if (k._IfImageChanged) {
            var g = c.one(k.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_save"),
                h = c.one(k.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_restore");
            if (g && g[0]) {
                g[0].style.display = "";
                h[0].style.display = ""
            }
...
(function(a) {
    ...
    e.prototype.SetBackgroundColor = function(h) {
        ...
        if (f) {
            k = f.one(".dynamsoft-dwt-container-box");
            if (k) {
...
(function(a) {
    ...
    a.cancelFrome = 0;
    a.dlgRef = 0;
    a.showProgress = function(l, g, e) {
        var k = l;
        a.log("showProgress:" + g + ",bCancel:" + e);
        if ((a.cancelFrome == 0 && k.__IfShowProgressBar == true) || (a.cancelFrome != 0 && k.__IfShowCancelDialogWhenImageTransfer == true)) {
            var j = a.one(".dynamsoft-btnCancel"),
                c = j && j[0];
            if (c) {
                if (e == false) {
            ...
            if (a.dialogShowStatus == false) {
                ...
                var d = a.one(".dynamsoft-finalMessage");
                var n = a.one(".dynamsoft-progressBar"),
                    f = n && n[0];
                var h = a.one(".dynamsoft-status");
                d && (d.html(""));
                h && (h.html("0%"));
                if (f) {
                    if (a.env.bIE) {
                        if (f.objProgressBar) {
                            f.objProgressBar.setValue(0)
                        } else {
                            f.value = 0
                        }
                    } else {
    ...
    a.closeProgress = function(c) {
        ...
        var d = a.one(".dynamsoft-btnCancel");
        if (a.needShowTwiceShowDialog == true && a.cancelFrome == 1) {
            if (d) {
                d[0].innerHTML = "Cancel"
            }
        } else {
            if (d) {
                d[0].innerHTML = "Cancel"
        ...
        if (!a.isUndefined(F.ProductKey)) {
            setTimeout(function() {
                ...
                a.getScript([U, "/dynamsoft.webtwain.install.js", X].join(""), V, function() {
                    var aa = [U, "/reference/dynamsoft_dwt_html5.css", X].join(""),
                        Z = function() {
